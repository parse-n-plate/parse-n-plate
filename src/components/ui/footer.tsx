      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex flex-col gap-[10px]">
            <h2 className="font-domine text-[48px] font-normal leading-[1.1] text-stone-50">
              Clean recipes,
              <br />
              fast cooking.
            </h2>
            <Link
              ...
              className="
                ...
                font-albert font-medium text-[14px] leading-[1.4] px-5 py-2 rounded-full
            ...
            <p className="font-albert text-[16px] leading-none text-stone-50">
